...
public final class VitalFeed extends JavaPlugin {
	...
	public void onEnable() {
		...
		Bukkit.getLogger().info("VitalFeed v" + this.getDescription().getVersion() + " enabled");
		...
		Bukkit.getLogger().info("See https://github.com/TamrielNetwork/VitalFeed/blob/main/LICENSE for more details.");
	}

	@Override
	public void onDisable() {

		Bukkit.getLogger().info("VitalFeed v" + this.getDescription().getVersion() + " disabled");
	}
